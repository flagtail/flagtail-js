...
import { DataIO as DataHandler, Element as ElementHandler } from "../utils/Handlers.js";
...
class Subscriber {
    ...
    */
    ...
    extract(id, target$_name){
        ...
        const wrap_$ = wrapper(pickedPub.getData()[target$_name]);

        console.log(wrap_$.val());
        console.log(wrap_$.text());
        console.log(wrap_$.attr("myAttribute"));
    }
